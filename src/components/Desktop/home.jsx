    ...
    <HomeContent>
      <div className="">
        ...
        <img
          src={rizal}
          alt="Jose Rizal"
          className="absolute right-12 bottom-12 w-64 sm:w-72 md:w-80 z-10 pointer-events-none"
        />

        {/* Main style */}
        <div className="relative z-20 max-w-[580px] 	ml-[190px] mr-auto mt-[40px] text-left pr-[30px] sm:pr-[36px] md:pr-[48px]">
          {/* Header */}
          <h1 className="text-[36px] sm:text-[55px] font-extrabold uppercase tracking-wide">
            JOSÉ RIZAL:
          </h1>
          <h2 className="text-xl sm:text-2xl mt-2 font-bold tracking-wider">
            THE DOCTOR, THE WRITER, <br /> THE REVOLUTIONARY
          </h2>
        </div>

        {/* Scroll and Published */}
        <p className="mt-0 ml-[90px] text-[16px] sm:text-lg font-bold flex items-center gap-2">
          <img src={scrollIcon} alt="Scroll" className="w-[90px] h-[90px]" />
          <span>Published: June 19, 1861 - Never Forgotten</span>
        </p>

        {/* Description */}
        <p className="-mt-5 ml-[90px] text-[16px] sm:text-[17px] leading-relaxed text-left max-w-[460px]">
