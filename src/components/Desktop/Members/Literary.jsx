...
const Literary = ({ setActiveTab }) => {
  ...
  const literature = [
    ...
    {
      name: "El Filibus&shy;terismo <span class='font-light font-serif'> (The Reign of Greed)</span>",
    ...
    {
      name: "Sobre la indolen&shy;cia de los filipinos  <span class='font-light font-serif'> (On the Indolence of the Filipinos)</span>",
    ...
    {
      name: "Sa Mga Kababa&shy;ihang Taga-Malolos   <span class='font-light font-serif'> (To the Young Women of Malolos)</span>",
    ...
    },
    {
      ...
      subDetails:
        "Published by Liceo Artistico Literario de Manila; reprinted by La Solidaridad in 1883",
      type: "drama",
              ...
              <div className=" w-[75%] mt-28 flex flex-col gap-5">
                <div className="scrollAnim fadeInUp flex flex-col-reverse lg:flex-row justify-between gap-2 ">
                  <div className="scrollAnim fadeInUp lg:h-full flex flex-col">
                    <h1
                      className={`lg:text-[2rem] text-center lg:text-left font-extrabold uppercase tracking-wide leading-none font-coustard break-words`}
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 w-full">
              {filteredLiterature.map((lit, index) => (
                <a onClick={() => setActiveLiterature(literature.indexOf(lit))}>
                  <div className="scrollAnim fadeInUp bg-no-repeat bg-cover bg-center relative flex justify-center min-h-[23rem]">
                    <img
                      src={Images.literaturePaper}
                      alt="paper"
                    ...
                    <img
                      src={Icons.inkPen}
                      alt="inkPen"
                      className="w-[40%] absolute -z-10 -right-2 top-[30%] lg:top-[38%]"
                      draggable={false}
                    />
                    <div className="w-[75%] mt-10 flex flex-col gap-0">
                      <div
                        className={`lg:pr-[5rem] gap-1 flex flex-col items-center lg:items-start min-w-0`}
                      >
                        <img
                          src={lit.img}
                          alt="literature"
                        ...
                        <h1
                          className={`text-[.8rem] ${
                            index != 4 && index != 3
                              ? "lg:text-[1rem]"
                              : "lg:text-[.8rem]"
                          } text-center lg:text-start font-extrabold uppercase tracking-wide leading-none font-coustard break-words whitespace-normal`}
                          dangerouslySetInnerHTML={{
                            __html: lit.name,
                          }}
                        />
                        ...
                        {index != 4 &&
                          index != 3 &&
                          !lit.name.includes("El Consejo de los Dioses") && (
                            <>
                              <h2
                                className={`text-[.8rem] ${
                                  index != 4 && index != 3
                                    ? "lg:text-[.6rem]"
                                    : "lg:text-[.2rem]"
                                } text-center lg:text-start tracking-wider leading-tight uppercase`}
                              >
                                {lit.published}
                              </h2>
                              <h2
